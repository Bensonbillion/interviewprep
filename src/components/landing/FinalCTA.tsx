  ...
  return (
    <section className="px-6 sm:px-14 py-24 bg-[#1C1713] text-center relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <ScrollReveal delay={1}><h2 className="font-[family-name:var(--font-serif)] text-[40px] sm:text-[58px] leading-[1.05] tracking-[-1.2px] text-[#F7F6F3] max-w-[680px] mx-auto mb-5">Your interview is<br /><em className="text-[#E8735A] not-italic">worth preparing for.</em></h2></ScrollReveal>
        <ScrollReveal delay={2}><p className="text-[15px] sm:text-[17px] text-[rgba(247,246,243,0.45)] max-w-[440px] mx-auto mb-10 leading-relaxed font-light">Build your company-specific kit in 5 minutes. Upload your resume, pick your company, and walk in knowing exactly what they&apos;re scoring.</p></ScrollReveal>
        <ScrollReveal delay={3}>
          ...
          <p className="text-[12px] text-[rgba(247,246,243,0.2)] mt-4">Free plan · 1 full kit · Upgrade for unlimited</p>
        </ScrollReveal>
